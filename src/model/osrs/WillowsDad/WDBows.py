...
class OSRSBowMaker(WillowsDadBot):
    def __init__(self):
        bot_title = "Bow Maker"
        description = "Place this near a bank with ingredients and it will make bows for you. Note: AFK doesn't always switch screens."
